...
class _MarketingBlastScreenState extends State<MarketingBlastScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Marketing Blast")),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_isLoading ? "CHECKING..." : "SEND BLAST"),
              ),
            ),
          ],
        ),
      ...
      if (mounted) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            title: const Text("🚀 Blast Sent!"),
            content: Text("Your message is being delivered to $_curentAudienceSize guests."),
            actions: [
              TextButton(
                onPressed: () {
