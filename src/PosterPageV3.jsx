...
const PosterPageV3 = () => {
  ...
  // Dynamic QR Destination URL points to Version 2 digital interactive choice screen
  ...
  return (
    <div className="min-h-[100dvh] bg-[#020205] text-amber-300 flex flex-col items-center justify-center p-2.5 sm:p-4 font-sans relative overflow-hidden select-none print:p-0 print:bg-black">
      ...
      {/* Printable Poster Container with White Phone Frame Contour */}
      <div id="v3-poster-card" className="w-full max-w-[430px] bg-[#08080E]/90 backdrop-blur-3xl border-2 border-white rounded-[48px] shadow-[0_25px_100px_rgba(0,0,0,0.95),0_0_55px_rgba(255,255,255,0.3)] overflow-hidden flex flex-col relative z-10 my-auto print:max-w-none print:w-[100vw] print:h-[100vh] print:rounded-none print:border-none print:shadow-none print:my-0 print:justify-between">
        ...
        <div className="px-3.5 pt-1.5 pb-3.5 relative flex flex-col items-center">
          ...
          {/* 🟢 TOP CARD: REVO */}
          <div className="w-full bg-gradient-to-b from-[#0D1C11]/90 via-[#09130C]/90 to-[#040805]/95 backdrop-blur-2xl border-2 border-[#00FF41]/40 rounded-[28px] p-3.5 pb-8 shadow-[0_0_30px_rgba(0,255,65,0.2)] relative z-10 overflow-hidden">
          ...
          {/* 🎁 BOTTOM CARD: GIFTX */}
          <div className="w-full bg-gradient-to-b from-[#240B1B]/90 via-[#160611]/90 to-[#0A0208]/95 backdrop-blur-2xl border-2 border-[#FFD700]/40 rounded-[28px] p-3.5 pt-8 shadow-[0_0_30px_rgba(255,215,0,0.2)] relative z-10 overflow-hidden">
        ...
        <div className="mx-3.5 mb-3.5 p-2.5 bg-gradient-to-r from-[#00FF41]/10 via-black/80 to-[#FF2A85]/10 border border-amber-400/20 rounded-2xl text-center flex items-center justify-center gap-2 shadow-inner backdrop-blur-lg">
          ...
          <span className="text-[11px] sm:text-sm font-black text-amber-300 tracking-wide uppercase drop-shadow-[0_0_6px_rgba(255,215,0,0.5)]">
